...
def main():
    ...
    parser.add_argument('-d', '--directory', help='process all .edf files in this directory', required=False)
    parser.add_argument('-m', '--markovsurrogates', help='number of Markov surrogates', required=False)
    ...
    for filename in filenames:
        ...
        n_maps = 4
        maps, x, gfp_peaks, gev, cv = kmeans(data, n_maps=n_maps, n_runs=5, doplot=True)
